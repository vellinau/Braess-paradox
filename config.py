...
T_CONNECTOR = 10        # Minutes it takes to drive through the connecting road
...
BUS_PENALTY_C1 = 1      # Penalties for taking a bus // taking a road rebuilt to fit a buslane
BUS_PENALTY_V2 = 1      # (no difference yet, since those cost the same)
T_BUSLANE = 80          # Minutes it takes to drive through the buslane (all at once)
