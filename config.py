...
T_CONNECTOR = 0        # Minutes it takes to drive through the connecting road
...
BUS_PENALTY_C1 = 2      # Penalties for taking a bus // taking a road rebuilt to fit a buslane
BUS_PENALTY_V2 = 2      # (no difference yet, since those cost the same)
T_BUSLANE = 70          # Minutes it takes to drive through the buslane (all at once)
